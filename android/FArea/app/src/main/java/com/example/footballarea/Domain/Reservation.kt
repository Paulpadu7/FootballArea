...
class Reservation() : Parcelable
{
    ...
    constructor(idReservation: Int?, idUser: Int?, match: Match?, no_of_tickets: Int?, reservation_date: String?, total_price: Int?)
            : this() {
    ...
    override fun toString(): String {
        return "Reservation(idReservation=$idReservation, idUser=$idUser, match=$match, no_of_tickets=$no_of_tickets, reservation_date=$reservation_date, total_price=$total_price)"
    }
